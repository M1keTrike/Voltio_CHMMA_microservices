...
var (
	...
	queueName       = getEnv("LIGHT_QUEUE_NAME", "LightSensor_queue")
	alertsQueueName = getEnv("ALERTS_QUEUE_NAME", "alerts-queue")
	wsURI           = getEnv("LIGHT_WEBSOCKET_URI", "wss://websocketvoltio.acstree.xyz/ws?topic=light_sensor&emitter=true")
